...
import persistent_objects.Model; // Custom class representing a model
import persistent_objects.SharedData; // Singleton class for shared data across the application
