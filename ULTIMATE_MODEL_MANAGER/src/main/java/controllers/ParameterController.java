...
public class ParameterController {
	...
	@FXML
	private Label modelDetails;

	@FXML
	private Button addDependencyParamButton;
	@FXML
	private Button addExternalParamButton;
	@FXML
	private Button addInternalParamButton;

	@FXML
	private ListView<UncategorisedParameter> uParamList;
	@FXML
	private ListView<DependencyParameter> dParamList; // each HBox will be generated by ParameterDisplay
	@FXML
	private ListView<ExternalParameter> eParamList;
	@FXML
	private ListView<InternalParameter> iParamList;

	@FXML
	private VBox undefinedParametersVBox;
	@FXML
	...
	private void setModelChangeListener() {
		// When a new model is selected, update the ListView with its uncategorised
		// parameters
	...
	// TODO handle the IOE better here with an alerter and same for the edit button
	// above /
	@FXML
