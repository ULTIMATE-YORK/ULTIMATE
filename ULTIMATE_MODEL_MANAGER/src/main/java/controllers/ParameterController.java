...
public class ParameterController {
	...
	private void setListCells() {
        ...
        iParamList.setCellFactory(listView -> {
            ...
            cell.setInternalUnitListener(new InternalParameterCell.InternalUnitListener() {
                @Override
                public void onEdit(InternalParameter iParam) {
                	try {
                        DialogOpener.openDialogWindow(sharedContext.getMainStage(), "/dialogs/edit_internal_param.fxml", "Edit Internal Parameter", iParam);
                	} catch (IOException e) {
                		e.printStackTrace();
                	}
                }
                ...
                @Override
                public void onRemove(InternalParameter iParam) {
	...
	@FXML
	private void addInParam() throws IOException {
