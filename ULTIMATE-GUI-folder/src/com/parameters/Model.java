...
public class Model {
	...
	public void addDependencyParameter(DependancyParameter parameter) {
    ...
    public boolean isParam(String param) {
        ...
        for (DependancyParameter dp : dependencyParameters) {
	...
	public void removeDependencyParameter(DependancyParameter toRemove) {
